...
data_type=st.sidebar.selectbox("Select Data Type", ["Transaction", "Users",'Users_brand',
                                                  ...
                                                  'Top Transaction PinCode','Top Users Data'])
#This section contains the data of aggregated transactions
if data_type=='Transaction':
    ...
    if chart_type == "Line Chart":#This block of code contains the line chart creation
        ...
        #Convert the year column Data type into a string
        Dc_1['Year'] = Dc_1['Year'].astype(str)
...
#This block contains the sunburst chart code
        ...
        Dc_a['Year'] = Dc_a['Year'].astype(str)
        st.header("Sunburst")
...
#Creation of tables for the aggregated users data
    ...
    Dcr_1['Year'] = Dcr_1['Year'].astype(str)
...
#Code for Sunburst data of aggregated users
        ...
        Dcr_a['Year'] = Dcr_a['Year'].astype(str)
...
#Creating code for users brand data and its chart
    ...
    Dcb_1['Year'] = Dcb_1['Year'].astype(str)
    if chart_type=='Brand_details':
        ...
        Dcb_a['Year'] = Dcb_a['Year'].astype(str)
...
#Creating code for top transactions of districts data
    ...
    Dtt_1['Year'] = Dtt_1['Year'].astype(str)
    if chart_type=="bar_amount":
        ...
        Dtt_a['Year'] = Dtt_a['Year'].astype(str)
...
# Creating code for top transactions pin code data and its visualisation charts
    ...
    Dtp_1['Year'] = Dtp_1['Year'].astype(str)
    ...
    if chart_type=='all data Sunburst':
        ...
        Dtp_a['Year'] = Dtp_a['Year'].astype(str)
    ...
    if chart_type=='bar':
        ...
        Dtu_u['Year'] = Dtu_u['Year'].astype(str)
        ...
        Dtu_a['Year'] = Dtu_a['Year'].astype(str)
